export default {
    ...
    reportFragment: (id) =>
        `${process.env.CMS_API_URL}reports/fragments/${id}/`,
    reports: `${process.env.CMS_API_URL}reports/`,
    quizByReport: (id) => `${process.env.CMS_API_URL}quiz/?report=${id}`,
    faqBySlug: (slug) =>
        `${process.env.CMS_API_URL}faqs/?slug=${slug}&withFragments=1`,
    fullFaqBySlug: (slug) =>
        `${process.env.CMS_API_URL}faqs/?slug=${slug}&allFragments=1`,
