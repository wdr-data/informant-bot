...
const countUpBubble = (subType) => {
    if (!subType) {
        ...
        return subType.replace('4', '5').replace('3', '4').replace('2', '3').replace('1', '2');
    }
    return subType;
};
                    ...
                    quickReplies.push(
                        quickReply(
                            'Nächstes Thema',
                            {
                                ...
                                track: {
                                    category: payload.track.category,
                                    event: push.reports[nextReportIndex].subtype ?
                                        `Letzte Meldung` :
                                        payload.track.event.
                                            replace('3', '4').replace('2', '3').replace('1', '2'),
                        ...
                        return quickReply(quickReplyText,
                            {
                                ...
                                track: {
                                    category: payload.track.category,
                                    event: r.subtype ? 'Letzte Meldung' :
