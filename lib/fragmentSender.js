        ...
        buttonNext = quickReply(
            button.question, {
                ...
                track: {
                    ...
                    subType: payload.subType.includes('Bubble') ?
                        payload.subType.replace('3', '4').replace('2', '3').replace('1', '2') :
                        payload.subType,
                        ...
                        quickReply(
                            'Nächstes Thema',
                            {
                                ...
                                track: {
                                    ...
                                    subType: '1.Bubble',
                                    publicationDate: push.reports[nextReportIndex].publicationDate,
                                },
                            })
                    );
                } else {
                ...
                quickReplies.push(
                    quickReply(
                        'Reicht jetzt',
                        {
                            ...
                            preview: payload.preview,
                            track: {
                                category: payload.trackcategory,
                                event: 'Push-Outro',
                                label: payload.before ?
                                    `${payload.before.length}-Fragmente` :
                                    'Klassik',
