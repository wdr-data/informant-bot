...
export const guessAttachmentType = function(filename) {
...
export const sendBroadcastText = (text, quickReplies = null, label = null) => {
    const message = { text: text };
...
export const sendBroadcastButtons = (text, buttons, label = null) => {
    const payload = {
        messages: [
            {
                attachment: {
