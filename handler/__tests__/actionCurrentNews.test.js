                ...
                [
                    {
                        ...
                        payload: {
                            ...
                            event: 'Luft in einigen NRW-Städten ist besser geworden',
                            label: 0,
                            push: 4,
                            report: 2,
                            type: 'push',
                    ...
                    },
                    {
                        ...
                        payload: {
                            ...
                            before: [],
                            category: 'push-Abendpush 21.03.',
                            event: 'Unfall löst Diskussion über selbstfahrende Autos aus',
                            label: 0,
                            push: 4,
                            report: 253,
                            type: 'push',
                    ...
                    },
                    {
                        ...
                        payload: {
                            ...
                            before: [],
                            category: 'push-Abendpush 21.03.',
                            event: 'Public Viewing wird auch nach 22 Uhr erlaubt',
                            label: 0,
                            push: 4,
                            report: 251,
                            type: 'push',
                    ...
                    },
                    {
                        ...
                        payload: {
                            ...
                            before: [],
                            category: 'push-Abendpush 21.03.',
                            event: 'Das Letzte: Deine Songs zum Glücklichsein',
                            label: 0,
                            push: 4,
                            report: 254,
                            type: 'push',
